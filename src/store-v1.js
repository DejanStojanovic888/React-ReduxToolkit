import { combineReducers, createStore } from 'redux';  // deprecated method(ReduxToolkit is recommended)
...
function accountReducer(state = initialStateAccount, action) {   // default value for state is initialStateAccount
  switch (action.type) {
...
console.log(store.getState())
store.dispatch(requestLoan(1000, "Buy an expensive car"))
console.log(store.getState())
